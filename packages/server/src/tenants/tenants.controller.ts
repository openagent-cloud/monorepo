...
import { AdminKey } from '../utils/decorators/api-key.decorator'
import {
  ApiTags,
  ApiOperation,
  ApiBody,
...
export class TenantsController {
  ...
  async create(@AdminKey() adminKey: string, @Body() dto: CreateTenantDto) {
  ...
  @ApiOperation({
    ...
    description:
      'Generates a new API key for the specified tenant. The old key will no longer work.',
  ...
  async regenerateKey(@AdminKey() adminKey: string, @Param('id') id: number) {
