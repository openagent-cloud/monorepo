...
export class ProxyController {
  ...
  @ApiOperation({
    ...
    description:
      "Forwards a request to the specified AI service using the tenant's stored credentials. Automatically tracks token usage for analytics.",
  ...
  @ApiParam({
    ...
    required: true,
    schema: {
      enum: Object.values(adapter_type)
    },
    example: 'openai',
    examples: {
      openai: {
