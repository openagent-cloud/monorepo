...
export class CredentialController {
  ...
  @ApiOperation({
    ...
    description: 'Creates or updates a credential for the specified service. If a credential already exists for this service, it will be updated.',
  ...
  @ApiCreatedResponse({
    ...
    schema: {
      allOf: [
        { $ref: getSchemaPath(CredentialResponseDto) },
      ],
    },
  })
  @ApiUnauthorizedResponse({
  ...
  @ApiOperation({
    ...
    description: 'Retrieves all credentials associated with the tenant. Credential keys are not included in the response for security reasons.',
  ...
  @ApiOperation({
    ...
    description: 'Permanently removes a credential from the tenant\'s account. This action cannot be undone.',
